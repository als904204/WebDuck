...
==== Request
include::{snippets}/get-v1-get-review/http-request.adoc[]
include::{snippets}/get-v1-get-review/path-parameters.adoc[]

==== Response
include::{snippets}/get-v1-get-review/http-response.adoc[]
include::{snippets}/get-v1-get-review/response-body.adoc[]
include::{snippets}/get-v1-get-review/response-fields.adoc[]
