...
include::{snippets}/get-v1-get-webtoonsByPublish/query-parameters.adoc[]
...
include::{snippets}/get-v1-get-webtoonsByPlatform/query-parameters.adoc[]
...
==== Request
include::{snippets}/get-v1-get-webtoonsByGenre/http-request.adoc[]
include::{snippets}/get-v1-get-webtoonsByGenre/query-parameters.adoc[]

==== Response
include::{snippets}/get-v1-get-webtoonsByGenre/http-response.adoc[]
include::{snippets}/get-v1-get-webtoonsByGenre/response-body.adoc[]
include::{snippets}/get-v1-get-webtoonsByGenre/response-fields.adoc[]
...
include::{snippets}/get-v1-get-webtoonsByGenres/query-parameters.adoc[]
...
include::{snippets}/get-v1-get-webtoonsByCondition/query-parameters.adoc[]
